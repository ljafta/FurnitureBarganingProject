import {
  ...
  export default function FinalCreateBatchEntry() {
            ...
            <Table>  
              ...
              <div style={{ alignItems: 'center' }}>
                <TableRow  >
                  ...
                  <TableCell ><Box className={classes.cell}><Typography className={classes.text}>Post to Period </Typography><Typography>: 2020/06/01 </Typography></Box></TableCell>
                ...
                <TableCell ><Box className={classes.cell}><Typography className={classes.text}>Status</Typography><Typography>: Unbalanced Unit </Typography></Box></TableCell>
  ...
  <TableHead>
    <div style={{ alignItems: 'center' }}>
      <TableRow  >
        ...
        <TableCell>Benefit Total: 6830.67</TableCell>
      </TableRow> 
      <TableRow  >
        <TableCell >Benefit Number: A 12956</TableCell>
        <TableCell>Surname: Thabo</TableCell>
        <TableCell>Weekly/Hourly Pay Rate: 1991.00</TableCell>
        <TableCell>Benefit Total: </TableCell>
      </TableRow> 
      </div>
  </TableHead>
  </Table>
          ...
          />
           <div>
              ...
              <IonButton style={{ float: 'right' }} routerLink="./create-employer">Post </IonButton>
